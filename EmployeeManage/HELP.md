...
* [Spring Data Reactive Couchbase](https://docs.spring.io/spring-boot/docs/3.1.2/reference/htmlsingle/#data.nosql.couchbase)
* [Spring Data Couchbase](https://docs.spring.io/spring-boot/docs/3.1.2/reference/htmlsingle/#data.nosql.couchbase)
